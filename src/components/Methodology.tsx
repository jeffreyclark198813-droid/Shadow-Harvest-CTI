...
import { ChevronLeft, BookOpen, Info, Layers, Share2, Activity } from 'lucide-react';
...
export const Methodology: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-screen bg-[#0a0a0a] text-gray-300 font-mono overflow-hidden">
      <header className="h-16 border-b border-[#222] flex items-center justify-between px-6 bg-[#0d0d0d]">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#1a1a1a] border border-[#333] rounded">
              <BookOpen size={18} className="text-[#00ff00]" />
            </div>
            <div>
              <h1 className="text-sm font-bold text-white tracking-tighter uppercase">Intelligence Methodology</h1>
              <p className="text-[10px] text-gray-500 uppercase tracking-widest">Standard Operating Procedures // Shadow Harvest</p>
            </div>
          </div>
        </div>
      </header>
